...
A=pd.read_csv('acc_{}_final.csv'.format(name),sep=',',usecols=[5],nrows=1000)
...
# Data['nday'] = pd.to_datetime(Data['day'])
# Data['weekend'] = Data['nday'].dt.dayofweek+1
# Data['isWeekend'] = Data['weekend'] >= 6
# del Data['nday']

Data.to_csv('{}月地铁人流量数据.csv'.format(name))